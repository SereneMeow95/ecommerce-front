...
const UpdateCategory = ({ match }) => {
            ...
            <form className="mb-5" onSubmit={submitCategoryForm}>
                ...
                <div className="form">
                    ...
                    <label htmlFor="name" className="label-name">
                        <span className="content-name">Category Name</span>
                    </label>
                </div>
                <br/>
                <div className="text-center">
                    <button type="submit" className="btn btn-outline-success btn-square">
                        Save Changes
                    </button>
                </div>
                {/*flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4*/}
                {/*<div className="text-center">*/}
    ...
    return (
        <Layout
            title={`Hi ${user.name}`}
            description={`Update Category Name Page`}
            className="container-fluid"
        >
            <div className="row">
                <div className="col-md-8 offset-md-2 m-b-250 mb-3">
                    {showError()}
                    {updateCategoryForm()}
                    {goBackBTN()}
                    {redirectUser()}
